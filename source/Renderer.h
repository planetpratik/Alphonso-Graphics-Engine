...
//		vk::UniqueHandle<vk::DeviceMemory, vk::DispatchLoaderDynamic> mDepthImageMemory;
//		vk::UniqueHandle<vk::ImageView, vk::DispatchLoaderDynamic> mDepthImageView;
//		vk::UniqueHandle<vk::Image, vk::DispatchLoaderDynamic> mDepthImage;
//
...
//		std::vector<vk::UniqueHandle<vk::ImageView, vk::DispatchLoaderDynamic>> mImageViews;
